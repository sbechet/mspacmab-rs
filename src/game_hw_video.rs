...
pub struct GameHwVideo {
    ...
    screen_color: [[ColorE; HEIGHT]; WIDTH],    // src:4400
...
impl GameHwVideo {
    pub fn new() -> Self {
        ...
        GameHwVideo {
            ...
            screen_color: [ [ColorE::Black; HEIGHT]; WIDTH],
    ...
    pub fn update(&mut self,) {
        ...
        for y in 0..HEIGHT {
            for x in 0..WIDTH {
                let tile = TileId::get_tile(&self.screen_tile[x][y], self.screen_color[x][y]);
    ...
    pub fn clear_tiles(&mut self) {
        ...
        self.screen_color = [ [ColorE::Black; HEIGHT]; WIDTH];
    ...
    pub fn clear_test_mode(&mut self) {
        self.screen_tile = [ [TileId::Space; HEIGHT]; WIDTH];
        self.screen_color = [ [ColorE::ColorFruit; HEIGHT]; WIDTH];
        self.clear_sprites();
    ...
    pub fn put_screen_color(&mut self, p: Point, c:ColorE) {
        ...
        let y = p.y as usize;
        // print!("({},{})",x,y);
        self.screen_color[x][y] = c;
        self.updated = true;
    }

    pub fn get_screen_color(&mut self, p: Point) -> ColorE {
        let x = p.x as usize;
        let y = p.y as usize;
        self.screen_color[x][y]
    }
